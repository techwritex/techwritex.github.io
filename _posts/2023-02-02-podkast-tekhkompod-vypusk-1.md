...
<p>
    <figure>
        <img src="{{ "images/statistika_01.png" }}" alt="Статистика вакансий технических писателей портала Работа России по сферам деятельности" style="border: 0px solid #D3D3D3;"/>

...
- если используется более одного уровня заголовков, убедитесь, что они явно визуально различаются

Пример:

| Вариант 1     | Вариант 2 |
| ----------- | ----------- |
| ### Первый уровень заголовка     | ### Первый уровень заголовка        |
| ### Второй уровень заголовка   | #### Второй уровень заголовка        |
| ### Третий уровень заголовка   | ##### Третий уровень заголовка        |
